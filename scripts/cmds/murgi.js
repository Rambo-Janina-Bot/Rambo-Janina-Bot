...
module.exports.onStart = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("রেম্বো বস খানকির পুলারে একটা মেনশন দে-!!🫂", event.threadID);
...
setTimeout(() => {a({body: "তোর মায়ের ভোদা বোম্বাই মরিচ দিয়া চুদামু। 🌶️!" + " " + name, mentions: arraytag})}, 9000);
